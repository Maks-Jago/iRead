...
//            let bookPath = Bundle.main.path(forResource: "book", ofType: "epub")!
            let bookURL = Bundle.main.url(forResource: "book3", withExtension: "epub")!
//            let bookBasePath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true)[0]
//            let bookURL2 = URL(fileURLWithPath: bookBasePath + "/" + bookURL.lastPathComponent)

//            try? FileManager.default.copyItem(at: bookURL, to: bookURL2)

            self.addEpubBookByShareUrl(bookURL)
        }
...
extension AppDelegate {
    ...
    func initReadConfig() {
        ...
        IRReaderConfig.isChinese = false
