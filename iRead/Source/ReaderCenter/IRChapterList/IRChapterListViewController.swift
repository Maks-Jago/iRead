...
enum IRSegmentType: String {
    /// 目录
    case chapter = "Table of contents"//"目录"
    /// 书签
    case bookmark = "Bookmark"//"书签"
}
...
//                emptyView?.setTitle("暂无书签", subTitle: "呼出阅读菜单，轻点“书签”按钮添加书签～")
                emptyView?.setTitle("No bookmarks yet", subTitle: "Call out the reading menu, tap the \"Bookmark\" button to add a bookmark~")
